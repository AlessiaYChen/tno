...
public class ReportSectionSettingsModel
{
    ...
    public bool RemoveRecentDuplicateTitles { get; set; }
    ...
    public ReportSectionSettingsModel(Dictionary<string, object> settings, JsonSerializerOptions options)
    {
        ...
        this.RemoveRecentDuplicateTitles = settings.GetDictionaryJsonValue("removeRecentDuplicateTitles", false, options)!;
    ...
    public ReportSectionSettingsModel(JsonDocument settings, JsonSerializerOptions options)
    {
        ...
        this.RemoveRecentDuplicateTitles = settings.GetElementValue("removeRecentDuplicateTitles", false, options)!;
